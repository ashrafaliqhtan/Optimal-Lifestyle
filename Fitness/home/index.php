...
$users = $link->query("SELECT * FROM usersmanage");
...
<html lang="en">
  <head>
    ...
    <title>Friends - optimal lifestyle</title>
  </head>
  ...
  <footer class="padding-footer">
      ...
      <div class="flex-row justify-around">
          <h5 class="footer-text ">Copyright © 2025    optimal lifestyle.    All rights reserved.</h5>
          <h5 class="footer-text">Saudi Arabia</h5>
      </div>
  </footer>
  </body>
</html>
