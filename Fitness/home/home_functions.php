...
function getUsernameWhoSentMessage($link, $user_id) {
    $username = mysqli_query($link,"SELECT * FROM usersmanage WHERE id='$user_id'");
...
function getUsernameById($link, $user_id) {
    $user = mysqli_query($link,"SELECT * FROM usersmanage WHERE id='$user_id'");
...
function getUserHeightById($link, $user_id) {
    $height = mysqli_query($link,"SELECT * FROM usersmanage WHERE id='$user_id'");
