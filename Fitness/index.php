...
<html lang="en">
  <head>
    ...
    <title>Sign In - optimal lifestyle</title>
    <style>
      .input-checkbox {
        margin-left: 10px;
        transform: scale(1.3);
        ...
        <div class="col translate" id="welcome">
          <div class="side-padding vertical-align margin-right-left">
            ...
            <h3 class="flex text-phrase">
              ...
              your health, with optimal lifestyle, you can track your activity, share
            ...
            <div class="login-form-container" id="signup">
              <h1 class="heading">Sign Up <br /></h1>
                ...
                <form action="sign/register.php" method="POST">
                  ...
                  <div class="form-group">
                    <label for="exampleInputAdmin">Register as Admin
                      <input
                        type="checkbox"
                        class="input-checkbox"
                        id="exampleInputAdmin"
                        name="is_admin"
                      />
                    </label>
                  </div>
