...
<div class="container text-center">
    <article>
        ...
        <ol>
            <img src="../Styles/pictures/articles-pictures/breakfast.jpg" class="img-fluid">
            <li class="list-item">BREAKFAST WILL HELP BUILD MUSCLE MASS</li>
            <p>You’ll need an immediate burst of energy and breakfast will help give you this. It’ll also help you stay full until your next meal or snack. It also sets the trend: you’ll tend to eat healthier if your day starts with a strong and healthy breakfast. Your best bets if you're trying to build muscle mass are omelettes, smoothies, and cottage cheese.</p>
            <img src="../Styles/pictures/articles-pictures/eating.png" id="eatingPic" class="img-fluid">
            <li class="list-item">EAT EVERY THREE HOURS</li>
            ...
            <img src="../Styles/pictures/articles-pictures/protein.jpg" class="img-fluid">
            <li class="list-item">PROTEIN WITH EACH MEAL HELPS BOOST MUSCLE MASS</li>
            <p>You need protein to build and maintain muscle mass. To achieve this, you should be looking to eat at least 1g per 454g of body-weight. That’s 200g/day if you weigh 91kg. The easiest way to get this amount is to eat a whole protein source with each meal. These include:
                <ul>
...
<div class="container" id="source">
    <p>Source: <a href="https://www.everyoneactive.com/content-hub/gym/muscle-mass" target="_blank">Click here for more</a></p>
</div>
<!-- Footer -->
